...
#define FRONT_THRESHOLD 250       // Front wall detection threshold in mm (increased for safety)
#define SIDE_WALL_THRESHOLD 20   // Side wall detection threshold in mm (no wall if > this)
